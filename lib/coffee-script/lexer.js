...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      ...
      // console.log("id:"+id+", colon:"+colon+", id.length:"+id.length); // G-:
      idLength = id.length;
      poppedToken = void 0;
    ...
    Lexer.prototype.numberToken = function() {
      ...
      number = number.replace(/_/g,''); // G-: added this line to remove underscores, while keeping the original length
  ...
  // NUMBER = /^0b[01]+|^0o[0-7]+|^0x[\da-f]+|^\d*\.?\d+(?:e[+-]?\d+)?/i; G-: was, now:
  NUMBER = /^0b[01](?:[01_]*[01])?|^0o[0-7](?:[0-7_]*[0-7])?|^0x[\da-f](?:[\da-f_]*[\da-f])?|^\d(?:[\d_]*\d)?(?:\.\d(?:[\d_]*\d)?)?(?:e[+-]?\d+)?/i;
